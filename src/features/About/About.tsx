        ...
        <FadeInSection>
          <Stack gap={2}>
            ...
            <Text mt={30} fw={400} fz={16} c={"brand.1"}>
              Brand Stories, based in Kerala, is a premier organization
              dedicated to fostering leadership, creativity, and organizational
              growth. Known for curating impactful events, Brand Stories
              connects industry leaders and changemakers to share knowledge,
              inspire growth, and implement meaningful change.
            </Text>
